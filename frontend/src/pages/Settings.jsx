          ...
          <div style={{ display: 'flex', gap: '0.25rem', flexShrink: 0 }}>
            {user?.telegram_connected ? (
              <>
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#dc2626" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                </button>
              </>
            ) : (
              <a href="https://t.me/food_order_pay_bot" target="_blank" rel="noreferrer"
                ...
                style={{ color: '#9ca3af' }}
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="5 12 3 12 12 3 21 12 19 12"/><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-7"/><polyline points="9 21 9 12 15 12 15 21"/></svg>
              </a>
            )}
          </div>
        </div>
